...
**Дисклеймер: совпадения с реальными вариантами случайны, варианты были подготовлены перед рубежной работой для тренировки различных возможных прототипов заданий**
